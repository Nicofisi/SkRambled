...
public class CondIsLeader extends Condition {
	...
	public boolean check(Event e) {
		...
		return isNegated() ? !(mplayer.getFaction() == fac && mplayer.getRole() == Rel.LEADER)
				: (mplayer.getFaction() == fac && mplayer.getRole() == Rel.LEADER);
