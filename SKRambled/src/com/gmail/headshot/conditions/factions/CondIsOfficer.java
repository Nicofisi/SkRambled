...
public class CondIsOfficer extends Condition {
	...
	public boolean check(Event e) {
		...
		return isNegated() ? !(mplayer.getFaction() == fac && mplayer.getRole() == Rel.OFFICER)
				: (mplayer.getFaction() == fac && mplayer.getRole() == Rel.OFFICER);
